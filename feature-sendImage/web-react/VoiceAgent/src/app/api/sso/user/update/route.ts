...
import { basicRemoteResSchema, REMOTE_USER_UPDATE } from '@/constants'
...
export async function POST(request: NextRequest) {
  ...
  const url = `${tokenServer}${REMOTE_USER_UPDATE}`
  logger.info(
    { tokenServer, agentServer, appId, devMode, endpoint, body, url },
  ...
  try {
    ...
    const resData = basicRemoteResSchema.parse(data)
